                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form_group mt-2">
                                    ...
                                    <input type="text" id="name" name="name" value="{{ $fees->name }}" class="form-control" placeholder="Enter customer name" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form_group mt-2">
                                    <label for="name" class="form-label">Customer ID</label>
                                    <input type="text" id="customerid" name="customerid" value="{{ $fees->customerid }}" class="form-control" placeholder="Enter customer ID" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form_group mt-2">
                                    <label for="name" class="form-label">Join Date</label>
                                    <input type="date" id="date" name="date" class="form-control" value="{{ $fees->join_date ?? '' }}" placeholder="Enter Date">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form_group mt-2">
                                    <label for="name" class="form-label">Fees Pay Date</label>
                                    <input type="date" id="date" name="date" class="form-control" value="{{ $fees->date ?? '' }}" placeholder="Enter Date">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form_group mt-2">
                                    ...
                                    <select id="package" name="package" class="form-select" required>
                                        ...
                                        <option value="Normal" {{ $fees->package == 'Normal' ? 'selected' : '' }}>Normal</option>
                                        <option value="Cardio" {{ $fees->package == 'Cardio' ? 'selected' : '' }}>Cardio</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form_group mt-2">
                                    ...
                                    <input type="number" id="amount" name="amount" class="form-control" value="{{ $fees->amount }}" placeholder="Enter amount">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form_group mt-2">
